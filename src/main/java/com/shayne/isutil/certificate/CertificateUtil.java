...
public class CertificateUtil {
	private static CertificateUtil certificateUtil = null;
	 ...
	 * 密钥库类型:PCKS12,默认是JCK
	 */
	public String storeType = KeyStore.getDefaultType();
	...
	public static CertificateUtil getInstance() {
		if (certificateUtil == null) {
			synchronized (CertificateUtil.class) {
				if (certificateUtil == null) {
	 ...
	 * @throws Exception
	 */
	public PrivateKey getPrivateKeyByKeyStore(String keyStorePath, String alias, String password) throws Exception {

		// 获得密钥库
		KeyStore ks = getKeyStore(keyStorePath, password);

		// 获得私钥这里的密码是密钥的密码，特别注意（只是这里的实现时，keystore和key的密码设置为了一样）
	 ...
	 * @throws Exception
	 */
	public byte[] decryptByPrivateKey(byte[] data, String keyStorePath, String alias, String password)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] sign(byte[] sign, String keyStorePath, String alias, String password, String certificatePath)
			throws Exception {
